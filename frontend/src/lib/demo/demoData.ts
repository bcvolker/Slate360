...
// Demo project data - using the simplified Project type
export const demoProjects: Project[] = [
  {
    ...
    status: 'In Progress',
    bimModelUrl: '/mock/office-complex.ifc'
  },
  {
    id: 'demo_proj_002',
  ...
  },
  {
    ...
    status: 'In Progress',
    bimModelUrl: '/mock/solar-farm.ifc'
  },
  {
    id: 'demo_proj_005',
...
export const getDemoProjectsByStatus = (status: string): Project[] => {
  return demoProjects.filter(project => project.status === status);
};

// Get demo projects by type (simplified - no type field in new Project)
export const getDemoProjectsByType = (type: string): Project[] => {
  // Since the new Project type doesn't have a type field, return all projects
  return demoProjects;
};

// Search demo projects
export const searchDemoProjects = (query: string, limit?: number): Project[] => {
